...
Functionality: **_Uses timer a few different ways_**
...
git clone https://github.com/jammazwan/xas_TimerOptions.git
cd jammazwan.shared
mvn install 
```
...
so you can focus only on what is required to demo the **TimerOptions** feature **_in isolation_**.
...
The prefix **xas** is used for maintaining sort order in a directory, providing packaging, and is otherwise meaningless. The x stands for _example_.
